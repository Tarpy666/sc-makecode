...
**Fleet designation:** `sc-makecode` · Part of the Counted fleet.

## Abstract

Dual-mode editor kernel: block/text sync, simulator, tutorial skillmaps. This repository ships a self-contained, deterministic implementation:
