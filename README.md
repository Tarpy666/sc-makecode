...
Dual-mode editor kernel: block/text sync, simulator, tutorial skillmaps.

Part of the Counted fleet (sc-makecode), stack class `frontend`, generated
from `seeds/seeds.yaml`.

## Architecture (docs/REPO_STANDARD.md)

- `src/lib/modules.ts` — module registry: BlockTextSync, Simulator, Skillmaps
